...
static void init_memmap(struct Page *base, size_t n) {
    pmm_manager->init_memmap(base, n);//为空闲内存创建Page结构
}

// alloc_pages - 调用 pmm->alloc_pages 来分配 n 个连续的页面
...
ffffffffc0201674:	e2048493          	addi	s1,s1,-480 # ffffffffc0211490 <pmm_manager>
        local_intr_save(intr_flag); // 保存并禁止中断
        { page = pmm_manager->alloc_pages(n); } // 调用底层的物理内存管理器来分配 n 个页面
        local_intr_restore(intr_flag); // 恢复中断状态

        // 如果成功分配到页面，或者需要分配多个页面，或者交换初始化失败，则跳出循环
        if (page != NULL || n > 1 || swap_init_ok == 0) break;//n>1???
...
ffffffffc020190e:	0fd00593          	li	a1,253
...
ffffffffc0201926:	10a00593          	li	a1,266
...
ffffffffc0201940:	10600593          	li	a1,262
...
ffffffffc020195a:	0fa00593          	li	a1,250
...
ffffffffc0201b16 <pmm_init>:
    pmm_manager = &default_pmm_manager;//内存管理器
...
ffffffffc02020ca:	1c800593          	li	a1,456
...
ffffffffc02020ea:	1c800593          	li	a1,456
...
ffffffffc020210a:	1c900593          	li	a1,457
...
ffffffffc020215e:	18e00593          	li	a1,398
...
ffffffffc020217e:	18f00593          	li	a1,399
...
ffffffffc020219e:	1bb00593          	li	a1,443
...
ffffffffc02021d6:	19500593          	li	a1,405
...
ffffffffc02021f6:	19300593          	li	a1,403
...
ffffffffc0202216:	1a000593          	li	a1,416
...
ffffffffc0202236:	19f00593          	li	a1,415
...
ffffffffc0202276:	19b00593          	li	a1,411
...
ffffffffc0202290:	19a00593          	li	a1,410
...
ffffffffc02022aa:	19900593          	li	a1,409
...
ffffffffc02022ca:	19700593          	li	a1,407
...
ffffffffc02022ea:	19600593          	li	a1,406
...
ffffffffc020230a:	1a900593          	li	a1,425
...
ffffffffc020232a:	1a800593          	li	a1,424
...
ffffffffc020234a:	1a700593          	li	a1,423
...
ffffffffc020236a:	1a600593          	li	a1,422
...
ffffffffc020238a:	1a500593          	li	a1,421
...
ffffffffc02023aa:	1a300593          	li	a1,419
...
ffffffffc02023ca:	1a200593          	li	a1,418
...
ffffffffc02023ea:	1a100593          	li	a1,417
...
ffffffffc020240a:	1e300593          	li	a1,483
...
ffffffffc020242a:	1db00593          	li	a1,475
...
ffffffffc020244a:	1d800593          	li	a1,472
...
ffffffffc020246a:	1d400593          	li	a1,468
...
ffffffffc020248a:	1b100593          	li	a1,433
...
ffffffffc02024ca:	1ad00593          	li	a1,429
...
ffffffffc02024ea:	1aa00593          	li	a1,426
...
ffffffffc020250a:	1b400593          	li	a1,436
...
ffffffffc020254a:	18d00593          	li	a1,397
...
ffffffffc0202562:	0bf00593          	li	a1,191
...
ffffffffc0202582:	1d300593          	li	a1,467
...
ffffffffc02025c2:	1d100593          	li	a1,465
...
ffffffffc02025e2:	1cd00593          	li	a1,461
...
ffffffffc020266e:	17500593          	li	a1,373
...
ffffffffc0202702:	1eb00593          	li	a1,491
...
ffffffffc020273c:	1ee00593          	li	a1,494
...
ffffffffc02027be:	1f400593          	li	a1,500
...
ffffffffc02027fc:	1f500593          	li	a1,501
